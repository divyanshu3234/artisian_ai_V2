...
export default function MarketPage() {
  ...
  const fallbackListings = [
    {
      id: "f1",
      name: "Authentic Kutch Embroidery Handbag",
      description: "Hand-stitched vintage embroidery sourced directly from Bhuj. Features mirror work and organic cotton.",
      price: 2450,
      image_url: "https://lh3.googleusercontent.com/aida-public/AB6AXuBCRuGgjqiCHFpMLvJSmCk1rr2usCtziAUDgezRxbJhIoNzmpgJ05D7TJQDESszDMaJK3SkeN2PyiuxTE5gjf6llRwRoXoXIi0VnsGDs6bsXw6FWIqFpURMMPyumgCL_8DGd_3TAkDOvuBOPxqmy_QyvyxlYCAIuH39kPSBNYtvMHO2i5cvjbQRW6_fd_Nw8iBks-8HoP2euWkdMmDNgYGiCTKv-HU9KFfALPIxmPD7on9IT80IKAF6zSJw-x9JA0XgwtBAZUHiJwDk",
    },
    {
      id: "f2",
      name: "Varanasi Silk Brocade Scarf",
      description: "Woven on traditional handlooms, this deep indigo silk scarf brings 200 years of heritage to modern fashion.",
      price: 4200,
      image_url: "https://lh3.googleusercontent.com/aida-public/AB6AXuBw8LHPj1ZUYzI9gyHZuqaNEXJTgO5dvcgyCSURhpjeDPkHlCXMLqXMbQjUQrYkBQWFTa7nv7YMmyRmWGss0JZfkGuUgakuZ4jUsA2ugd-b8tzW8fmyQtBt_kTawx4vtN3Q-uAzCjkf1VStmszGv7mTu-J7PvrHNpwWKdmphTeBiz1iVuuYWWEUuTgIR9nhZezbvEmDe2_A7xeqLPmbN6vNADM40lYX5s6WKlnU1dkZyTgaKOYIspv_5CZbBuSMMuCGJs9mjZWIqv1-",
    },
    {
      id: "f3",
      name: "Jaipur Blue Pottery Platter",
      description: "Turquoise blue ceramic platter painted by master artisans in Rajasthan. Perfect for home decor or serving.",
      price: 1850,
      image_url: "https://lh3.googleusercontent.com/aida-public/AB6AXuBvQWGe-J75LaW5ENl0r8jcsxHgqdg_frE_8fNrfzORz831t8Mk8rXvlcaegojkXrBKVoHLp7wmSaip6cXDPPbmo4Sk2bcobKQLpKA_ToUhgUPrJug9cqR0DOynjZi0b2g7Q4uHDnSMfmMh1g6FC4fmcITliybuJPHvINOBJhX1j81YTHuf71gqYNKvkZtJK1U9tQxyQk7pHTkApN0C12LZ0zVFNKydPodTE_UQxeQ-Wb1QXmVzCGltGHieY94QhtgOQr9Qd4knzIkQ",
    },
    {
      id: "f4",
      name: "Terracotta Earth Pitcher",
      description: "Natural clay water pitcher that naturally cools water. Sourced from the kilns of Khurja.",
      price: 950,
      image_url: "https://lh3.googleusercontent.com/aida-public/AB6AXuB-zdRhUfR1GC-TFFka8EsKgmXgmpWI9OblyQokzXVcuUiI5yXGUm7nlVyMFCHm7oUmV6BjtmNE7ki0z5VYnZo-6zPT_8G3uozZnpCptz85vrOWM39woUGmMTYwe5YJueIgOGUoZPT9a88dol8Utmv8PdgoV2_KlsYQoDi502V5cnQ0hJf_bKz-kjJx45o2nm8xMEMfQJaoWBqB5O0ezpGGbXhtZgl3YRnE_L31JUpIenJdwFniC9P-_0wSA5ImFj-Lh86bE_HpPq_O",
    }
  ];
              ...
              <div key={item.id} className="group bg-surface-container rounded-3xl overflow-hidden border border-outline-variant/30 shadow-ambient transition-all hover:-translate-y-2 hover:shadow-[0_20px_50px_rgba(0,0,0,0.12)]">
                ...
                <div className="p-6 flex flex-col justify-between" style={{ minHeight: '190px' }}>
                  ...
                  <div className="mt-6 pt-4 border-t border-outline-variant/10">
                    <button onClick={() => toast.success('Added to Cart! Checkout in Wallet.')} className="w-full flex items-center justify-center gap-3 bg-foreground hover:bg-primary text-background hover:text-white py-3.5 rounded-2xl font-bold text-sm tracking-tight active:scale-95 transition-all shadow-md">
